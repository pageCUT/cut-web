...
(function () {
  ...
  function initNav() {
    ...
    /* ── Smooth scroll with correct offset (topbar 34 + nav 64 = 98) ── */
    document.querySelectorAll('a[href^="#"]').forEach(function (a) {
      a.addEventListener('click', function (e) {
        ...
        if (el) {
          e.preventDefault();
          var offset = 98; /* topbar(34) + nav(64) */
  ...
  function createA11yPanel() {
    // Remove any existing fab/panel to avoid duplicates
    var existingFab = document.getElementById('uwFab');
    var existingPanel = document.getElementById('uwPanel');
